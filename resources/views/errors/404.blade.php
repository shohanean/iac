...
<img src="{{ asset('frontend_assets') }}/images/resource/404.jpg" alt>
...
was never existed.</p>
<a href="{{ route('home') }}" class="theme-btn btn-style-one shop-now"><span class="btn-title">Back to Home</span></a>
</div>
</div>
</div>
</div>
