        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand"
                        href="../../../html/ltr/vertical-menu-template-semi-dark/index.html"><span class="brand-logo">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/icons/toolbox.svg"
                                                                        alt="Toolbar svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/icons/parachute.svg"
                                                                        alt="Parachute svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/icons/brush.svg"
                                                                        alt="Brush svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/icons/star.svg"
                                                                        alt="Star svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/icons/book.svg"
                                                                        alt="Book svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/icons/rocket.svg"
                                                                        alt="Rocket svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar rounded">
                                                                <div class="avatar-content">
                                                                    <img src="{{ asset('dashboard_assets') }}/images/icons/speaker.svg"
                                                                        alt="Speaker svg" />
                                                                </div>
                                                            </div>
                                                            <div>
                            ...
                            <div class="card card-browser-states">
                                ...
                                <div class="card-body">
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('dashboard_assets') }}/images/icons/google-chrome.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('dashboard_assets') }}/images/icons/mozila-firefox.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('dashboard_assets') }}/images/icons/apple-safari.png"
                                    ...
                                    <div class="browser-states">
                                        <div class="d-flex">
                                            <img src="{{ asset('dashboard_assets') }}/images/icons/internet-explorer.png"
