<div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        @endcan
        @can('country operation')
            <li class="nav-item">
                <a class="d-flex align-items-center" href="#">
                    <i class="far fa-flag"></i>
                    <span class="menu-title text-truncate" data-i18n="Charts">Country</span>
                </a>
                <ul class="menu-content">
                    <li class="@yield('country.create')"><a class="d-flex align-items-center"
                            href="{{ route('country.create') }}"><i data-feather="circle"></i><span
                                class="menu-item text-truncate" data-i18n="Chartjs">Add
                                Country</span></a>
                    </li>
                    <li class="@yield('country.index')"><a class="d-flex align-items-center"
                            href="{{ route('country.index') }}"><i data-feather="circle"></i><span
                                class="menu-item text-truncate" data-i18n="Apex">All
                                Countries</span></a>
                    </li>
                </ul>
            </li>
        ...
        @can('blog operation')
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li class="@yield('blog.index')"><a class="d-flex align-items-center"
                            href="{{ route('blog.index') }}"><i data-feather="circle"></i><span
                                class="menu-item text-truncate" data-i18n="Apex">All
                                Blog</span></a>
                    </li>
                </ul>
        ...
        <li class="@yield('role') nav-item">
            <a class="d-flex align-items-center" href="{{ route('role') }}">
                <i class="fas fa-tasks"></i>
                <span class="menu-title text-truncate" data-i18n="Leaflet Maps">Role Manager</span>
            </a>
        </li>
        ...
        <li class="nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    data-i18n="Charts">Reserved</span><span
