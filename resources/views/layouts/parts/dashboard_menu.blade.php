<div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item">
            ...
            <ul class="menu-content">
                <li class="@yield('country.create')"><a class="d-flex align-items-center" href="{{ route('country.create') }}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Chartjs">Add
                            Country</span></a>
                </li>
                <li class="@yield('country.index')"><a class="d-flex align-items-center" href="{{ route('country.index') }}"><i
                            data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Apex">All
                            Countries</span></a>
                </li>
            </ul>
