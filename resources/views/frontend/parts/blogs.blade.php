                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <span class="date"><b>{{ $blog->created_at->format('d') }}</b> {{ $blog->created_at->format('M') }}</span>
                            </div>
                            <div class="content-box">
                                ...
                                <a href="{{ route('blogs.details', $blog->slug) }}" class="read-more">Read More <i class="fa fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                @empty
