                ...
                <div class="blog-details__left">
                    ...
                    <div class="blog-details__content">
                        <ul class="list-unstyled blog-details__meta">
                            <li><a href="news-details.html"><i class="fas fa-user-circle"></i> {{ $blog->user->name }}</a> </li>
                    ...
                    <div class="comment-one">
                        ...
                        <div class="comment-one__single">
                            <div class="comment-one__image"> <img src="https://via.placeholder.com/145x145" alt=""> </div>
                            <div class="comment-one__content">
                                ...
                                <a href="news-details.html" class="theme-btn btn-style-one bg-theme-color4 comment-one__btn"><span class="btn-title">Reply</span></a>
                            </div>
                        </div>
                        <div class="comment-one__single">
                            <div class="comment-one__image"> <img src="https://via.placeholder.com/145x145" alt=""> </div>
                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar__single sidebar__post">
                        ...
                        <ul class="sidebar__post-list list-unstyled">
                            ...
                            <li>
                                <div class="sidebar__post-image"> <img src="{{ asset('uploads') }}/{{ $latest->image }}" alt=""> </div>
                                <div class="sidebar__post-content">
                                    <h3> <span class="sidebar__post-content-meta"><i
                                        class="fas fa-user-circle"></i>{{ $latest->user->name }}</span> <a href="{{ route('blogs.details', $latest->slug) }}">{{ $latest->heading }}</a>
                                    </h3>
                                </div>
                            </li>
                            @endforeach
