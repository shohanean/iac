...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard_assets') }}/css/plugins/forms/form-validation.css">
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('dashboard_assets') }}/images/pages/register-v2.svg" alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control @error('name') error @enderror" id="register-name" type="text" name="name" placeholder="johndoe" aria-describedby="register-name" autofocus="" tabindex="1" value="{{ old('name') }}"/>
                                        @error('name')
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control @error('email') error @enderror" id="register-email" type="text" name="email" placeholder="john@example.com" aria-describedby="register-email" tabindex="2" value="{{ old('email') }}"/>
                                        @error('email')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge @error('password') error @enderror" id="register-password" type="password" name="password" placeholder="············" aria-describedby="register-password" tabindex="3" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                        </div>
                                        @error('password')
                                            <span class="error">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="confirm-password" type="password" name="password_confirmation" placeholder="············"/>
                                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('dashboard_assets') }}/js/scripts/pages/auth-register.js"></script>
    <!-- END: Page JS-->
