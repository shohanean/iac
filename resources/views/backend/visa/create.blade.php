...
@section('breadcrumb')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Add Add{{ $term }}</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea name="short_details" class="form-control" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-1">
                                    <label class="form-label">Long Details</label>
                                    <textarea name="long_details" class="form-control" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
