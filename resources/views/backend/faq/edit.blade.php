...
@section('breadcrumb')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Edit FAQ - {{ $faq->question }}</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('faq.index') }}">All FAQ</a>
                        </li>
    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">
                        You can <code>edit</code> FAQ here
                    </p>
                    @if (session('success'))
