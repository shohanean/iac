...
@section('breadcrumb')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">All {{ Str::plural($term) }}</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">All {{ Str::plural($term) }}
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All {{ Str::plural($term) }}</h4>
                </div>
                <div class="card-body">
                    <p class="card-text">
                        You will see all your {{ Str::plural($term) }} here. You can <code>edit</code> and also can
                        <code>active/deactive</code>
                        {{ Str::plural($term) }} here.
                    </p>
                            ...
                            <tbody>
                                @forelse ($countries as $country)
                                    <tr>
                                        ...
                                        <td>
                                            <img width="150" src="{{ asset('uploads') }}/{{ $country->image }}"
                                                alt="not found">
                                        </td>
